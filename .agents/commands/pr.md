...
tags, and publishes to crates.io.
...
in Cargo.toml, updates the lockfile, creates a git tag, and publishes to
crates.io — so do not run the release process yourself here.
